  ...
  const submit = React.useCallback(
    async (
      ...
      try {
        if (mode === "stellar") {
          ...
          if (synced) {
            toast.success(
              ...
              toastOptions(
                t("hooks.useRepay.toast.confirmed.desc"),
                explorerUrl,
              ),
            );
          } else {
            toast.success(
              ...
              toastOptions(
                t("hooks.useRepay.toast.syncPending.desc"),
                explorerUrl,
              ),
            );
          }
        ...
        const bal: bigint = await (
          usdc as unknown as { balanceOf(addr: string): Promise<bigint> }
        ...
        ).allowance(userAddress, evaultAddress);
        ...
        if (allowance < allowanceTarget) {
          ...
          if (synced) {
            toast.success(
              ...
              toastOptions(
                t("hooks.useRepay.toast.confirmedBatch.desc"),
                explorerUrl,
              ),
            );
          } else {
